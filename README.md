...
| OrangeTrace | E-commerce Platform for Nagpur based orange market. AI-based system to detect orange freshness using image processing and ML models. | Python, OpenCV, React.js, Node.js, Next.js |
